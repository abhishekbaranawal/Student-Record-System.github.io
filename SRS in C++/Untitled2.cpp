...
void ClearConsoleToColors(int ForgC, int BackC)
{
 ...
 FillConsoleOutputCharacter(hStdOut, (TCHAR) 32, csbi.dwSize.X * csbi.dwSize.Y, 
coord, &count);
 FillConsoleOutputAttribute(hStdOut, csbi.wAttributes, csbi.dwSize.X * csbi.dwSize.Y, 
coord, &count );
...
void main_window(){
 ...
 gotoxy(x,16);printf("4. Delete Student Record");
 gotoxy(x,18);printf("5. Change password");
 gotoxy(x,20);printf("6. Exit");
